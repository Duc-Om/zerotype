<?php
    require('control.php');
    $getData = new Data();
    $selectID = $getData->add_content($tilte,$username,$s_content,$l_content,$date);
?>
<!DOCTYPE HTML>
<html>
    ...
    <div id="contents">
        <div class="section">
            ...
            <form method="post" class="message">
                <input type="text" name="tilte" value="">
                <input type="text" name="username" value="">
                <textarea name="s_content" cols="30" rows="10" value="" ></textarea>
                <textarea name="l_content" cols="30" rows="10" value=""></textarea>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    if(checkValue()){
                        $add = $getData->add_content($_POST['tilte'],$_POST['username'],str_replace("'","'",$_POST['s_content']),str_replace("'","'",$_POST['l_content']),$_POST['date']);
                        if($add != null){
                            echo "<script>alert('Update'); window.location = ('adminIndex.php')</script>";
                        }
                    }
                }
            ?>
